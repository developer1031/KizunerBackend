    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-bordered bt-10">
                <div class="card-inner">
                    <form class="form-validate is-alter" method="post" action="{{ route('admin.sample-help.import') }}" enctype="multipart/form-data">
                        @csrf
                        <span class="preview-title-lg overline-title">Import From Excel file</span> <small><a href="{{ asset('assets/sample_help.xlsx') }}">Download sample</a></small>
            ...
            <div class="card card-bordered bt-10">
                <div class="card-inner">
                    ...
                    <form
                        ...
                        action="@if($sampleHelp->id) {{ route('admin.sample-help.update', ['id' => $sampleHelp->id]) }} @else {{ route('admin.sample-help.store') }} @endif"
        ...
        <div class="col-md-8">
            <div class="card card-bordered">
                <div class="card-inner">
                    <span class="preview-title-lg overline-title">Sample Help List</span>
...
@section('page-script')
    <script>
        $('#chat-intent-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.sample-help.data') }}',
            columns: [
                {data: 'image'},
                {data: 'title'},
                {
