...
@section('content')
    <div class="card card-bordered">
        <div class="card-inner">
            <span class="preview-title-lg overline-title">Hangout List</span>
                ...
                },
                {
                   ...
                   render: function (data, type, row) {
                        return '<div class="drodown">\n' +
                            ...
                            '                        <li><a href="/hangouts/' +row.id+ '"><em class="icon ni ni-eye view-detail-hangout"></em><span>View Details</span></a></li>\n' +
                            '                        <li><a href="/hangouts/' +row.id+ '/offers"><em class="icon ni ni-repeat"></em><span>Offers</span></a></li>\n' +
                            '                        <li class="divider"></li>\n' +
                            '                        <li><a href="/hangouts/' +row.id+ '/delete"><em class="icon ni ni-trash-alt"></em><span>Delete</span></a></li>\n' +
                            '                    </ul>\n' +
                            '              </div>\n' +
                            '    </div>'
                   }
